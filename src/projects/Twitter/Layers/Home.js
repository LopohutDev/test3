    ...
    <div className="m-4 border-2 border-black">
      <div className="flex flex-col-reverse w-full font-sans bg-blue-300 lg:h-screen lg:flex-row">
        ...
        <div className="z-10 flex items-center h-32 bg-white lg:hidden">
          ...
          <button className="w-full h-10 mx-2 text-sm font-bold text-blue-400 border border-blue-400 rounded-full hover:bg-blue-50">
            Log in
          </button>
        </div>
        ...
        <div className="z-10 flex items-center justify-center h-full text-xl font-bold bg-white lg:w-1/2">
          <div className="max-w-sm">
            <div className="w-10 mb-5 text-blue-400 fill-current">
              <svg
                viewBox="0 0 24 24"
            ...
            <p className="mt-20 text-sm">Join Twitter today.</p>
            <button className="w-full h-10 mt-4 text-sm font-bold text-white bg-blue-400 rounded-full hover:bg-blue-500">
              Sign up
            </button>
            <button className="w-full h-10 mt-4 mb-5 text-sm font-bold text-blue-400 border border-blue-400 rounded-full hover:bg-blue-50">
              Log in
            </button>
          </div>
        </div>
